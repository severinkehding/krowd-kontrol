...
## Follow-up (same day, operator playtest round 2)

The 160px cap made every row wrap onto 2-3 lines ("text wraps like crazy" —
operator, 2026-08-26). Operator decision: readability of the live objective beats
issue #247's original ~15% ceiling — `TrackerWidthPx` widened 160px → 260px
(284px footprint, ~22.2% of the 1280px minimum target resolution) and the
resolution-safety test's envelope relaxed from 15% to 25% to pin the new bound.
